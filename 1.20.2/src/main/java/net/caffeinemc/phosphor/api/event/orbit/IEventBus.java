package net.caffeinemc.phosphor.api.event.orbit;

import net.caffeinemc.phosphor.api.event.orbit.listeners.IListener;
import net.caffeinemc.phosphor.api.event.orbit.listeners.LambdaListener;
...
public interface IEventBus {
     ...
     * @param packagePrefix Package prefix that this factory will be used for, eg "ru.pycat.clientbase.api.event.orbit"
