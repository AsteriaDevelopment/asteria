...
import net.caffeinemc.phosphor.imixin.IExplosion;
...
public class ExplosionMixin implements IExplosion {
    ...
    @Override
    public void set(Vec3d explosionPos, float power, boolean createFire) {
        this.world = mc.world;
        this.entity = null;
        this.x = explosionPos.x;
        this.y = explosionPos.y;
        this.z = explosionPos.z;
        this.power = power;
