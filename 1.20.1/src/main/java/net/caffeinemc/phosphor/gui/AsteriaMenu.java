    ...
    public Theme getTheme() {
        return new Theme() {
            ...
            public void preRender() {
                ...
                colors[ImGuiCol.FrameBg]                = new float[]{0.65f, 0.24f, 0.33f, 0.54f};
                colors[ImGuiCol.FrameBgHovered]         = new float[]{0.68f, 0.21f, 0.31f, 0.40f};
                colors[ImGuiCol.FrameBgActive]          = new float[]{0.68f, 0.21f, 0.31f, 0.67f};
                ...
                colors[ImGuiCol.CheckMark]              = new float[]{0.68f, 0.16f, 0.27f, 1.00f};
                colors[ImGuiCol.SliderGrab]             = new float[]{0.65f, 0.14f, 0.25f, 1.00f};
                colors[ImGuiCol.SliderGrabActive]       = new float[]{0.70f, 0.15f, 0.27f, 1.00f};
                colors[ImGuiCol.Button]                 = new float[]{0.65f, 0.24f, 0.33f, 0.59f};
                colors[ImGuiCol.ButtonHovered]          = new float[]{0.65f, 0.24f, 0.33f, 1.00f};
                colors[ImGuiCol.ButtonActive]           = new float[]{0.57f, 0.21f, 0.29f, 1.00f};
                colors[ImGuiCol.Header]                 = new float[]{0.65f, 0.24f, 0.33f, 1.00f};
                colors[ImGuiCol.HeaderHovered]          = new float[]{0.76f, 0.17f, 0.30f, 1.00f};
                colors[ImGuiCol.HeaderActive]           = new float[]{0.83f, 0.18f, 0.33f, 1.00f};
                ...
                colors[ImGuiCol.ResizeGrip]             = new float[]{0.65f, 0.24f, 0.33f, 0.59f};
                colors[ImGuiCol.ResizeGripHovered]      = new float[]{0.76f, 0.17f, 0.30f, 1.00f};
                colors[ImGuiCol.ResizeGripActive]       = new float[]{0.76f, 0.17f, 0.30f, 1.00f};
                colors[ImGuiCol.Tab]                    = new float[]{0.60f, 0.22f, 0.30f, 0.86f};
                colors[ImGuiCol.TabHovered]             = new float[]{0.76f, 0.17f, 0.30f, 0.80f};
                colors[ImGuiCol.TabActive]              = new float[]{0.62f, 0.14f, 0.25f, 1.00f};
